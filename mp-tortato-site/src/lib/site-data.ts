export const siteData = {
  ...
  contact: {
    ...
    whatsappPrimaryLabel: "(41) 99263-9915",
    emails: ["comercial@mptortato.com.br"],
    address: {
      street: "Rua Francisco Batista Claudino, 300",
  ...
  timeline: [
    {
      ...
      body: [
        "Nascido em Curitiba, Angelo Paulo Tortato desenvolveu desde muito jovem um grande apreço pela área de montagem e pelo ambiente industrial. Ao longo de sua trajetória profissional, passou por diversos segmentos e empreendimentos, acumulando experiências e conhecimentos que moldaram sua visão de trabalho e gestão.",
        "Foi no setor de estruturas metálicas, entretanto, que encontrou sua verdadeira vocação. Com anos de atuação na área, construiu sua carreira exercendo diferentes funções, desde lixador e montador até encarregado de grandes projetos, adquirindo uma ampla experiência prática e um profundo conhecimento dos processos de fabricação e montagem industrial.",
      ],
      future: false,
      image: null,
    },
    {
      year: "2022",
      title: "O nascimento da MP Tortato.",
      body: [
        "Após uma trajetória marcada por dedicação, aprendizado e paixão pelo setor metalúrgico, Angelo Paulo Tortato decidiu dar um novo passo em sua história. Ao lado de seu filho, em 2022 fundou a MP Tortato, unindo experiência, valores familiares e uma visão voltada para o futuro da indústria.",
        "Em um primeiro barracão de pouco mais de 120 m², a empresa iniciou suas atividades com o propósito de entregar soluções de qualidade, compromisso e confiança aos seus clientes. O que começou de forma simples rapidamente se transformou em uma trajetória de crescimento contínuo, impulsionada pelo trabalho, pela credibilidade e pela busca constante pela excelência em estruturas metálicas.",
      ],
      future: false,
      image: "/empresa/historia-1.jpg",
    },
    {
      year: "2023",
      title: "Expansão e nova estrutura fabril.",
      body: [
        "O crescimento acelerado e a conquista de projetos cada vez mais desafiadores levaram a MP a um novo patamar. Em 2023, foi inaugurado o primeiro barracão de aproximadamente 700 m², ampliando significativamente a capacidade produtiva da empresa. A nova estrutura trouxe investimentos em máquinas, equipamentos e processos mais modernos, elevando os padrões de precisão, produtividade e qualidade. Com a implantação de novas tecnologias de fabricação, maior capacidade de movimentação e processos mais eficientes, a MP passou a atender projetos de maior porte, consolidando sua atuação no mercado de estruturas metálicas pesadas e soluções industriais de alta complexidade.",
      ],
      future: false,
      image: "/empresa/historia-2.jpg",
    },
    {
      year: "Em breve",
  ...
  obras: [
    ...
    {
      slug: "continental",
      cliente: "Continental Pneus",
      segmento: "Indústria Química",
      ano: "2023",
      local: "Camaçari/BA",
      escopo: ["Equipamentos", "Fabricação"],
      titulo: "Fabricação de tanques de armazenamento",
      descricao:
        "Fabricação de tanques de armazenamento sob medida — engenharia, fabricação e controle de qualidade do recebimento da chapa à expedição final.",
      thumb: "https://s3.directum.com.br/mptortato/continental/1.webp",
      gallery: [
        "https://s3.directum.com.br/mptortato/continental/1.webp",
        "https://s3.directum.com.br/mptortato/continental/2.webp",
        "https://s3.directum.com.br/mptortato/continental/3.webp",
      ],
    },
    {
      slug: "elco",
...
export const servicos = [
  {
    ...
    short: "Galpões, coberturas e estruturas portantes sob medida.",
    icon: "frame",
  },
  {
    title: "Plataformas",
    short: "Acessos e plataformas industriais para operação e manutenção.",
    icon: "layers",
  },
  {
    title: "Guarda-corpo",
    short: "Proteção perimetral conforme norma de segurança.",
    icon: "shield",
  },
  {
    title: "Skid",
    short: "Conjuntos modulares montados em base estrutural única.",
    icon: "boxes",
  },
  {
    title: "Pipe Racks",
    short: "Suportação estrutural para tubulações e bandejas.",
    icon: "pipe",
  },
  {
    title: "Equipamentos",
    short: "Caldeiraria e equipamentos industriais sob projeto.",
    icon: "cog",
  },
  {
    title: "Suportação",
...
export const segmentos = [
  {
    title: "Celulose",
    short: "Estruturas e equipamentos para plantas de celulose e papel.",
    icon: "trees",
  },
  {
    title: "Óleo e Gás",
    short: "Skids, racks e estruturas para óleo, gás e petroquímica.",
    icon: "fuel",
  },
  {
    title: "Agronegócio",
    short: "Aço para armazenagem, processamento e operação rural.",
    icon: "wheat",
  },
  {
    title: "Indústria Química",
    short: "Suportação e equipamentos para processos químicos.",
    icon: "flask",
  },
  {
    title: "Indústria Alimentícia",
    short: "Estruturas em aço para linhas e plantas alimentícias.",
    icon: "utensils",
  },
  {
...
export const features = [
  {
    ...
    body: "Projeto, dimensionamento e fabricação sob o mesmo teto. Menos retrabalho, prazo enxuto.",
    icon: "compass",
    metric: { value: "1", suffix: "teto", label: "Engenharia + fábrica" },
  },
  {
    title: "Aço com rastreabilidade",
    body: "Chapa, certificado e processo registrados — controle de qualidade do recebimento à expedição.",
    icon: "shieldCheck",
    metric: { value: "100", suffix: "%", label: "Lote rastreável" },
  },
  {
    title: "Parque fabril próprio",
    body: "+700m² em Curitiba com corte, dobra, solda MIG/TIG, usinagem e pintura industrial.",
    icon: "factory",
    metric: { value: "700", suffix: "m²", label: "Parque fabril" },
  },
  {
    title: "Equipe técnica qualificada",
    body: "Soldadores certificados, engenheiros e montadores treinados em norma técnica e prazo crítico.",
    icon: "hardHat",
    metric: { value: "MIG", suffix: "/TIG", label: "Solda certificada" },
  },
  {
    title: "Prazo acordado, prazo cumprido",
    body: "Planejamento de produção e logística para entregar dentro da janela combinada.",
    icon: "clock",
    metric: { value: "100", suffix: "%", label: "Janela combinada" },
  },
  {
    title: "Atendimento direto",
    body: "Conversa direta com os sócios em qualquer fase do projeto — decisão rápida, sem filtro.",
    icon: "handshake",
    metric: { value: "24h", suffix: "", label: "Resposta média" },
  },
];

export type Obra = (typeof siteData.obras)[number];
export type Servico = (typeof servicos)[number];
export type Segmento = (typeof segmentos)[number];
export type GalleryIcon = Servico["icon"] | Segmento["icon"];
